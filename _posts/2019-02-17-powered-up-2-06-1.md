...
I'm splitting my time between building the router table (*that's the second project in the course*), and editing the video for the first project, the [shop cabinet]({{ site.baseurl }}{% post_url 2019-01-21-powered-up-1-2-2 %}). Let me take you through one of the things I deal with, when putting together a video.
